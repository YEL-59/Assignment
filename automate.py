    ...
    while True:
        if msgDate == today:
            ...
            if current_time >= msgTime:
                ...
                options.add_argument(r'--user-data-dir=C:C:\Users\USER\AppData\Local\Google\Chrome\User Data\Default')
                options.add_argument('--profile-directory=Default')

                chrome_browser = webdriver.Chrome(
                    executable_path=r'C:\Users\USER\AppData\Local\SeleniumBasic', options=options)
